...
This javascript file contains the page for when you click onto "Objects game" under "Educational Tools"
*/
import React, { Component } from 'react';
import "./ObjectsStyles.css";
import OBSQuestions from './ObjectsQuestions';
import QuestionBox from "./ObjectsQuestionBox";
import OBSReplay from "./ObjectsReplay";
 
class OBSGame extends Component {
  ...
  render() {
    return (
      ...
      <div className = 'OBSBackground'>
        <div className="largeContainer">
          <div className="titleBox">Objects Game</div>
          ...
          {this.state.numAnswers === 6 ? (
            <OBSReplay numCorrectAnswers={this.state.numCorrectAnswers} playAgain={this.playAgain} />
          ) : null}
        </div>
      </div>
    );
